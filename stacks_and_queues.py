...
off the stack, then compare the two characters to see if they are the same; as long as the characters match,
...
line containing string s. It then calls the methods specified above to pass each character to your instance variables.
...
print 'The word, s, is a palindrome'; otherwise, it will print 'The word, s, is not a palindrome.'
